...
1. **Θεμέλια** — scaffold, Prisma schema (πλήρες), Auth.js + permission-based RBAC, S1 client + live δοκιμή, pg-boss, UI shell/branding
2. **PIM pull** — sync ειδών/κατηγοριών/ΜΜ/αποθεμάτων/τιμών, οθόνες προϊόντων, CBM πεδία
...
6. **Πελάτες, επαφές & εσωτερικές παραγγελίες** — TRDR αμφίδρομο, SALDOC push, ροή εγκρίσεων
7. **Containers & δυναμική τιμολόγηση** — οντότητα, price engine, οθόνες, portal ένδειξη
8. **B2B Portal + Αρχιτέκτονες** — customer/architect login, τιμές πελάτη, καλάθι, προμήθειες
