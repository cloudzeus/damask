...
8. **Πρότυπος κατάλογος (user: «ο πίνακας είναι πάνω-κάτω ίδιος για όλα τα προγράμματα»)**: ενσωματωμένος iso κατάλογος `src/lib/pm/deliverable-catalog.ts` με standard παραδοτέα-ομάδες + tasks ανά είδος δαπάνης/υποχρέωσης, βασισμένος στα τυπικά παραρτήματα πιστοποίησης (π.χ. **Δαπάνες προσωπικού/μισθοδοσία**: μισθοδοτικές καταστάσεις, εμβάσματα/extrait, ασφαλιστική & φορολογική ενημερότητα, Ε4, αναγγελία ΟΑΕΔ/ΔΥΠΑ, ταυτότητα, ΑΠΔ — με ✓ επιτόπιας επαλήθευσης· **Εξοπλισμός**: προσφορά, τιμολόγιο, extre, φωτογραφίες, σειριακοί, μητρώο παγίων, βεβαίωση καινούργιου· **Λογισμικό**: προσφορά, τιμολόγιο, extre, screenshots, άδειες χρήσης· **Άδειες λειτουργίας**· **Κτιριακά/διαμόρφωση**· **Προβολή**). Χρήσεις: (α) panel «Βοήθεια/Πρότυπα» στο wizard με one-click εισαγωγή ομάδας → προεπιλεγμένα tasks/φάσεις/minFiles που ο admin προσαρμόζει· (β) στόχος αντιστοίχισης στο extraction/matching (C2g.3) — «για κάθε δαπάνη ή υποχρέωση συμπληρώνεται αυτός ο πίνακας».
