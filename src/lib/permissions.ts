...
export const ROLE_DEFAULTS: Record<string, string[]> = {
  ...
  EMPLOYEE: ['product.view', 'customer.view', 'order.view', 'order.create', 'cms.view', 'pm.work', 'lead.view', 'regions.view', 'kad.view'],
