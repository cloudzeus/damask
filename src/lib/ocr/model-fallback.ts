...
//
// Generic (not OCR-specific) — lives here because it was introduced for the
// OCR vision pipeline (src/lib/ocr/extract.ts), but src/lib/gemini.ts (the
// shared Gemini REST client) is the actual consumer of these two functions.
