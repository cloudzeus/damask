  ...
  return (
    <div className="glass mb-3 flex flex-wrap items-center gap-x-3 gap-y-2 px-4 py-2.5">
      <div className="min-w-0 flex-1">
        {breadcrumb && (
          <div className="mb-0.5 flex items-center gap-1.5 text-[11px] font-semibold text-muted-foreground">
            {breadcrumb}
          </div>
        )}
        <h1 className="text-[16px] leading-tight font-bold text-foreground">{title}</h1>
