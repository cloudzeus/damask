    ...
    <div className="glass p-5">
      <div className="mb-4 flex items-center gap-2.5">
        ...
        <div className="min-w-0">
          ...
          <p className="text-[0.75rem] text-muted-foreground">Φωτογραφία ή PDF τιμολογίου, απόδειξης ή δελτίου αποστολής.</p>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Select value={docType} onValueChange={v => setDocType(v as OcrDocTypeHint)}>
              <SelectTrigger aria-label="Τύπος εγγράφου" className="h-9 min-w-[190px] rounded-full border-border bg-card px-3.5 text-[0.78125rem]">
      ...
      {phase === 'processing' && (
        <div className="flex flex-col items-center justify-center gap-3 py-14 text-center" role="status">
          ...
          <p className="text-[0.875rem] font-semibold">{PROCESSING_STEPS[stepIndex]}</p>
          <p className="text-[0.75rem] text-muted-foreground">Συνήθως ~10-25 δευτερόλεπτα — μην κλείσεις αυτό το παράθυρο.</p>
        </div>
      )}
